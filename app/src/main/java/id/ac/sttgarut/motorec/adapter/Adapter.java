...
public class Adapter extends RecyclerView.Adapter<Adapter.ViewHolder> {
    ...
    private List<SparePart> mApps;
    private boolean mHorizontal;
    private boolean mPager;

    public Adapter(boolean horizontal, boolean pager, List<SparePart> apps) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        if (mPager) {
            ...
            return mHorizontal ? new ViewHolder(LayoutInflater.from(parent.getContext())
                    .inflate(R.layout.adapter_sparepart, parent, false)) :
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        SparePart app = mApps.get(position);
        holder.imageView.setImageResource(R.drawable.sparepart);
        holder.nameTextView.setText(app.getNama());
        holder.btsTextView.setText(String.valueOf(app.getBataspakai())+" Km");
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public ViewHolder(View itemView) {
            ...
            btsTextView = (TextView) itemView.findViewById(R.id.btsTextView);
